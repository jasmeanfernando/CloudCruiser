...
<html>
	...
	if (session.getAttribute("user") == null) {
		...
		try {
			...
			String questionEmail = (String)session.getAttribute("user");
			String questionInquiry = request.getParameter("questionInquiry");
			...
			try {
				// Add a question.
				if (questionEmail != null && questionInquiry != null) {
					qa.addQuestion(questionEmail, questionInquiry);
					out.print("<p class=\"cc_paragraph\">Added question.</p>");
					out.println("<a class=\"cc_button\" href=\"PassengerQA.jsp\">Back</a>");
				}
			}

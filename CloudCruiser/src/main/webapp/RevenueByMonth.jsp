...
<% } else { %>
	<% try {
		...
		String month = request.getParameter("month_num");
		...
		//Create query.
		String aggregateSql = "SELECT SUM(F.TotalPrice) AS TotalPriceForMonth, COUNT(R.ReservationNumber) AS NumberOfReservations " +
                              "FROM Reservation R " +
        ...
        aggregateStatement.setString(1, month);

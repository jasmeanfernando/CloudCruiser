...
<html>
	...
	%>
		...
		<%
		User user = new User ();
		String firstName = user.getUserInformation("Passenger", (String)session.getAttribute("user"), "FirstName");
		%>
		<p class="cc_heading text-center">Welcome back, <%=firstName%>!</p>
		
		<!-- Passenger Pages -->
		<div class="row justify-content-center">
			<a class="cc_button" href="PassengerFlights.jsp">Flights</a>
		</div>
		<div class="row justify-content-center">
			<a class="cc_button" href="PassengerReservations.jsp">Reservations</a>
		</div>
		<div class="row justify-content-center">
			<a class="cc_button" href="PassengerQA.jsp">Q&A Forum</a>
		</div>
		<div class="row justify-content-center">

...
<% } else { %>
	<% try {
		...
		//Create query.
		String aggregateSql = "SELECT SUM(F.TotalPrice) AS TotalPriceForFlight, COUNT(R.ReservationNumber) AS NumberOfReservations " +
                              "FROM Reservation R " +
        ...
        aggregateStatement.setString(1, flight);
